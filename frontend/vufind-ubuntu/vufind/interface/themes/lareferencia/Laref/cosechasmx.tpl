...
Descargar Archivo con todos los identificadores <a target="_blank" href="{$url}/getRecordsCSV.php?iso=MX&url=http://localhost:8080/backend/public/listInvalidRecordsInfoBySnapshotID/{$lastid}">CSV</a>

<iframe width="100%" src="{$url}/getRecords.php?iso=MX&url={$ws}/public/listInvalidRecordsInfoBySnapshotID/{$lastid}"></iframe>
