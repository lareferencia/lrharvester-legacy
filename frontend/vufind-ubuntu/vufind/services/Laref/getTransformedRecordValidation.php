 ...
 */
class getTransformedRecordValidation extends Action
{
    /**
    ...
    public function launch()
    {
		...
		if(isset($_GET["id"]))
		{
			...
			$output7.= "<table border='0' style='font-family:Verdana;font-size:8pt;background-color:#B5B5D1'>";

			$output7.= "<tr> <th> REGISTRO TRANSFORMADO</th></tr>";
			$url2=$ws."/public/validateTransformedRecordByID/$id";
