...
class CosechasCO extends Action
{
    /**
	...
	$output4="";
		...
		$url=$ws."/public/lastGoodKnowSnapshotByCountryISO/CO";
   ...
   //echo print_r($data);
	...
	$url2=$ws."/public/listSnapshotsByCountryISO/CO";
