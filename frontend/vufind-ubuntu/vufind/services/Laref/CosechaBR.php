 ...
 */
class CosechaBR extends Action
{
    /**
						...
						{					
						 ...
						 else if ($key2==="validSize")
						 {
							...
							if (!$first)
								...
								{
									$first=false;
									$output8.='[new Date("2013/05/09").getTime(),212000],['.$datetemp.','.$valtemp.'],[new Date("2013/06/09").getTime(),'.$valtemp.']';
								}
...
////////////////////////////////////////////////////////////////////		
		...
		$interface->setTemplate('cosechabr.tpl');
