...
class Origen extends Action
{
	...
	$result = mysql_query("SELECT count(*) as acceso,ccode FROM record WHERE ccode<>'' OR not(NULL) GROUP BY ccode ORDER BY ccode ") 
	or die(mysql_error());  
	$table="";
	$list="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('origen.tpl');
        $interface->setPageTitle('Origen');
