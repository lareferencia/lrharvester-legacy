...
class Favorites extends MyResearch
{
    ...
    public function launch()
    {
        ...
        global $user;
					...
					//echo $user->admin_country;
			//$page = $user->admin_country<>""?
            //$configArray['Site']['defaultAccountPage'] : 'Cosecha$user->admin_country';
        ...
        $interface->setPageTitle('Favoritos de '.$user->username.' ('.$user->admin_country.')');
