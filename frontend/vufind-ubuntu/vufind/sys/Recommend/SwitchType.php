 ...
 * @link     http://vufind.org/wiki/building_a_recommendations_module Wiki
 */
class SwitchType implements RecommendationInterface
{
    protected $searchObject;
    protected $newIndex;        // search index to try
    protected $newIndexName;    // on-screen description of index
    ...
    public function __construct($searchObject, $params)
    {
        ...
        $this->newIndex = !empty($params[0]) ? $params[0] : 'AllFields';
        $this->newIndexName = isset($params[1]) ? $params[1] : 'All Fields';
    }
    ...
    public function process()
    {
        ...
        if (!is_null($searchType) && $searchType != $this->newIndex) {
            ...
            $interface->assign(
                'widenedUrl',
                $this->searchObject->renderLinkWithReplacedIndex(
                    $searchType, $this->newIndex
                )
            );
        }
    }
    ...
    {
        return 'Search/Recommend/SwitchType.tpl';
    }
}
