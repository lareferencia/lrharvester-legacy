 ...
 * @link     http://vufind.org/wiki/building_a_recommendations_module Wiki
 */
class FacetCloud implements RecommendationInterface
{
    ...
    public function process()
    {
        ...
        $facets = $this->_searchObject->getFacetList($this->_facets, true);
        ...
        $limit = is_callable(array($this->_searchObject, 'getFacetLimit'))
            ? $this->_searchObject->getFacetLimit() - 1 : 100000;

        $interface->assign('facetCloudSet', $facets);
        $interface->assign('cloudLimit', $limit);
    }
    ...
    {
        return 'Search/Recommend/FacetCloud.tpl';
    }
}
