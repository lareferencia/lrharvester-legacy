 ...
 *
 */
class PorMaterialMX extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE red='MX' group by red,type order by type") 
	or die(mysql_error());  
	$table="";
	$list="";
	$list.="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialmx.tpl');
        $interface->setPageTitle('Impacto por Material - M&eacute;xico');
