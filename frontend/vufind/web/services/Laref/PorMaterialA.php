 ...
 *
 */
class PorMaterialA extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE ((ccode<>'' OR not(NULL)) AND (type='Artículo')) group by red,type order by total desc") 
	or die(mysql_error());  
	$table="";
	$list="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormateriala.tpl');
        $interface->setPageTitle('Impacto por Art&iacute;culo');
