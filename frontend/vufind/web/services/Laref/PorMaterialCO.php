 ...
 *
 */
class PorMaterialCO extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE red='CO' group by red,type order by type") 
	or die(mysql_error());  
	$table="";
	$list="";
	$list.="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialco.tpl');
        $interface->setPageTitle('Impacto por Material - Colombia');
