 ...
 *
 */
class PorMaterialTD extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE ((ccode<>'' OR not(NULL)) AND (type='Tesis de Doctorado')) group by red,type order by total desc") 
	or die(mysql_error());  
	$table="";
	$list="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialtd.tpl');
        $interface->setPageTitle('Impacto por Tesis de Doctorado');
