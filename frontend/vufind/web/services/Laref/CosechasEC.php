 ...
 */
class CosechasEC extends Action
{
    /**
	...
	$output4="";
		...
		$url="http://lareferencia.shell.la:8090/public/lastGoodKnowSnapshotByCountryISO/EC";
   ...
   //echo print_r($data);
	...
	$url2="http://lareferencia.shell.la:8090/public/listSnapshotsByCountryISO/EC";
...
////////////////////////////////////////////////////////////////////		
		...
		$interface->setTemplate('cosechasec.tpl');
        $interface->setPageTitle('Cosechas Ecuador');
