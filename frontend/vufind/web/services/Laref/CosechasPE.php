 ...
 */
class CosechasPE extends Action
{
    /**
	...
	$output4="";
		...
		$url="http://lareferencia.shell.la:8090/public/lastGoodKnowSnapshotByCountryISO/PE";
   ...
   //echo print_r($data);
	...
	$url2="http://lareferencia.shell.la:8090/public/listSnapshotsByCountryISO/PE";
...
////////////////////////////////////////////////////////////////////		
		...
		$interface->setTemplate('cosechaspe.tpl');
        $interface->setPageTitle('Cosechas Per&uacute;');
