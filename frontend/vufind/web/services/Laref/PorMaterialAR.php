 ...
 *
 */
class PorMaterialAR extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE red='AR' group by red,type order by type") 
	or die(mysql_error());  
	$table="";
	$list="";
	$list.="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialar.tpl');
        $interface->setPageTitle('Impacto por Material - Argentina');
