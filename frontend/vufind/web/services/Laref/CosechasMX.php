...
class CosechasMX extends Action
{
	...
	$output4="";
		...
		$url="http://lareferencia.shell.la:8090/public/lastGoodKnowSnapshotByCountryISO/MX";
   ...
   //echo print_r($data);
	...
	$url2="http://lareferencia.shell.la:8090/public/listSnapshotsByCountryISO/MX";
