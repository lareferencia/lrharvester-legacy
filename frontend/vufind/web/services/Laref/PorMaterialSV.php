 ...
 *
 */
class PorMaterialSV extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE red='SV' group by red,type order by type") 
	or die(mysql_error());  
	$table="";
	$list="";
	$list.="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialsv.tpl');
        $interface->setPageTitle('Impacto por Material - El Salvador');
