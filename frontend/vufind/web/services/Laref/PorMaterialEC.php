 ...
 *
 */
class PorMaterialEC extends Action
{
    /**
	...
	$result = mysql_query("SELECT count(*) as total,red,type from record WHERE red='EC' group by red,type order by type") 
	or die(mysql_error());  
	$table="";
	$list="";
	$list.="";
...
////////////////////////////////////////////////////////////////////		
        ...
        $interface->setTemplate('pormaterialec.tpl');
        $interface->setPageTitle('Impacto por Material - Ecuador');
