...
class CosechasVE extends Action
{
	...
	$output4="";
		...
		$url="http://lareferencia.shell.la:8090/public/lastGoodKnowSnapshotByCountryISO/VE";
   ...
   //echo print_r($data);
	...
	$output1.=  "<tr> <th>Pa&iacute;s</th><th>ID</th><th>Status</th><th>Fecha de actualizaci&oacute;n</th><th>Registros consultados</th><th>Registros incorporados</th></tr>";
		...
		$url2="http://lareferencia.shell.la:8090/public/listSnapshotsByCountryISO/VE";
