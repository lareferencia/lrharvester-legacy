<?php
echo '<ul>';
$url2 = 'http://localhost:8080/solr/biblio/select?facet=true&facet.field=instname&fl=instname&q=instname'.urlencode(':[* TO *]').'&facet.limit=100&rows=0&facet.sort=index';
//echo $url2;
...
foreach ($xml2->xpath("//lst[@name='instname']/int") as $date) 
    {
