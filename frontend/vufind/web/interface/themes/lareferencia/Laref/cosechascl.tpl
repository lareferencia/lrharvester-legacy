...
Descargar Archivo con todos los identificadores <a target="_blank" href="{$url}/getRecordsCSV.php?iso=CL&url=http://200.0.207.91:8080/backend/public/listInvalidRecordsInfoBySnapshotID/{$lastid}">CSV</a>

<iframe width="100%" src="{$url}/getRecords.php?iso=CL&url=http://200.0.207.91:8080/backend/public/listInvalidRecordsInfoBySnapshotID/{$lastid}"></iframe>
