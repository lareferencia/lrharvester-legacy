...
<div id="list2container" class="span-5 browseNav">
  <ul class="browse" id="list2">
    ...
    {if $lccEnabled}<li><a href="{$url}/Browse/Author" class="loadSubjects query_field:authorStr facet_field:country target:list3container">{translate text="Por Pais"}</a></li>{/if}
    {if $topicEnabled}<li><a href="{$url}/Browse/Author" class="loadSubjects query_field:authorStr facet_field:topic_browse target:list3container">{translate text="By Topic"}</a></li>{/if}
    ...
    {if $countryEnabled}<li><a href="{$url}/Browse/Author" class="loadSubjects query_field:authorStr facet_field:country target:list3container">{translate text="Por Pais"}</a></li>{/if}
