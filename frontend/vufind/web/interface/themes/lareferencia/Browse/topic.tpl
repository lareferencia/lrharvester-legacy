...
<div class="span-5 browseNav">
  <ul class="browse" id="list2">
    <li><a href="{$url}/Browse/Topic" class="loadAlphabet query_field:topic_browse facet_field:topic_browse target:list3container">{translate text="By Alphabetical"}</a></li>
    ...
    {if $countryEnabled}<li><a href="{$url}/Browse/Topic" class="loadSubjects query_field:topic_browse facet_field:country target:list3container">{translate text="Por Pais"}</a></li>{/if}
