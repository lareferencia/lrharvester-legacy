...
class IndexRecord implements RecordInterface
{
    ...
    public function getCoreMetadata()
    {
	    ...
	    // CAMBIOS AR BANDERA Y ENLACE MAY01

        $interface->assign('coreCountry', $this->getCountry());
		$interface->assign('coreCountryISO', $this->getCountryISO());		
        $interface->assign('coreId', $this->getUniqueID());
    ...
    public function getHoldings($patron = false)
    {
		...
		// LAREFERENCIA AR MAY01
        $interface->assign('holdingId', $this->getUniqueID());
    ...
    {
        return $this->fields['country_iso'];
    }	
