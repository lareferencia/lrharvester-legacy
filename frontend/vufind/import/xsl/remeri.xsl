<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="institution">Red Mexicana de Repositorios Institucionales</xsl:param>
    <xsl:param name="collection">REMERI</xsl:param>
        ...
        <add>
            <doc>
               ...
               <xsl:for-each select="//dc:type">
                   <xsl:if test="substring(., 1, 4) = &quot;info&quot;">
                       <field name="format">
                           <xsl:value-of select="." />
                       </field>
                   </xsl:if>
