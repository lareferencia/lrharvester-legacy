...
public class SnapshotPersistenceTests {
	 ...
	 * @Test
	 * 
	 * @Transactional public void testLGK() throws Exception {
	 * 
	 ...
	 * @Test
	 * 
	 * @Transactional public void testSaveAndGet() throws Exception {
	 * NationalNetwork nn = new NationalNetwork(); nn.setName("A name");
	 * 
	 * OAIOrigin o = new OAIOrigin(); o.setUri("test.uri");
	 * nn.getOrigins().add(o);
	 * 
	 * 
	 * OAISet s = new OAISet(); s.setName("set1");
	 * s.setDescription("la descripción");
	 * 
	 * o.getSets().add(s);
	 * 
	 * Country c = new Country(); c.setIso("AR"); c.setName("Argentina");
	 * nn.setCountry(c);
	 * 
	 ...
	 * 
	 * assertEquals(1, loadedNN.getOrigins().size()); assertEquals(o,
	 * loadedNN.getOrigins().iterator().next());
	 * 
	 * assertEquals(s,
	 * loadedNN.getOrigins().iterator().next().getSets().iterator().next());
	 * 
