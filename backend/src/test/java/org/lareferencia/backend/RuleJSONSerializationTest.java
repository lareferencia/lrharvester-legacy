...
public class RuleJSONSerializationTest {
	...
	/*
	 * @Test public void testPropertySerialization() throws Exception {
	 * 
	 * String outputFile = "test.json";
	 * 
	 * ControlledValueContentValidationRule rule = new
	 * ControlledValueContentValidationRule();
	 * 
	 ...
	 * valores.add("valor1"); valores.add("valor2");
	 * 
	 * rule.setControlledValues(valores);
	 * 
	 * ObjectMapper mapper = new ObjectMapper(); mapper.registerSubtypes(
	 * ContentLengthValidationRule.class, ContentLengthValidationRule.class );
	 * 
	 * mapper.writerWithDefaultPrettyPrinter().writeValue(new FileWriter(new
	 * File(outputFile)), rule);
	 * 
	 * }
	 */
	...
	/***
	 * @Test public void testPropertyDeserialization() throws Exception {
	 * 
	 *       String outputFile = "test.json";
	 * 
	 *       ObjectMapper mapper = new ObjectMapper(); mapper.registerSubtypes(
	 *       ContentLengthValidationRule.class,
	 *       ContentLengthValidationRule.class );
	 * 
	 *       IValidatorRule rule =
	 *       mapper.readValue(FileUtils.readFileToByteArray(new
	 *       File(outputFile)), AbstractValidatorRule.class);
	 *       System.out.println(rule);
	 * 
	 *       }
	 * @Test public void testValidatorRuleSerializationPersistence() throws
	 *       Exception {
	 * 
	 * 
	 *       ControlledValueContentValidationRule rule = new
	 ...
	 * 
	 *       validatorRepository.save(vvalidator); validatorRepository.flush();
	 * 
	 *       System.out.println(jsonString);
	 * 
	 *       }
	 * @Test public void testValidatorRuleSerializaer() throws Exception {
	 * 
	 *       ControlledValueContentValidationRule rule = new
	 *       ControlledValueContentValidationRule(); ContentLengthValidationRule
	 *       rule2 = new ContentLengthValidationRule();
	 * 
	 *       FieldContentNormalizeRule trule = new FieldContentNormalizeRule();
	 *       trule.setFieldName("dc:type");
	 *       trule.setRemoveDuplicatedOccurrences(true);
	 ...
	 * 
	 *       String jsonString =
	 *       serializer.serializeTransformerToJsonString(trule);
	 * 
	 *       System.out.println(jsonString);
	 * 
	 *       System.out.println(serializer.deserializeTransformerFromJsonString(
	 *       jsonString));
	 * 
	 *       }
	 **/
