...
public class TransformerTests {
	...
	/*
	 * @Test public void testSameFieldContentTranslateTransformer() throws
	 * Exception {
	 * 
	 ...
	 * trule.setTestFieldName("dc:type"); trule.setWriteFieldName("dc:type");
	 ...
	 * 
	 * 
	 * Boolean found = false; for (String occr :
	 * record.getFieldOcurrences("dc:type") ) { found |=
	 * occr.equals("artículo"); }
	 * 
	 * assertFalse(found);
	 * 
	 * found = false; for (String occr : record.getFieldOcurrences("dc:type") )
	 * { found |= occr.equals("Article"); }
	 * 
	 * assertTrue(found); }
	 * 
	 * 
	 * @Test public void testDifferentFieldContentTranslateTransformer() throws
	 * Exception {
	 * 
	 * OAIRecordMetadata record = new OAIRecordMetadata("dumyid",invalidRecord);
	 * 
	 * FieldContentTranslateRule trule = new FieldContentTranslateRule();
	 * trule.setTestFieldName("dc:type"); trule.setWriteFieldName("dc:test");
	 * trule.getTranslationMap().put("artículo", "Article");
	 ...
	 * Boolean found = false; for (String occr :
	 * record.getFieldOcurrences("dc:type") ) { found |=
	 * occr.equals("artículo"); } assertTrue(found);
	 * 
	 * found = false; for (String occr : record.getFieldOcurrences("dc:test") )
	 * { found |= occr.equals("Article"); } assertTrue(found); }
	 * 
	 * @Test public void testDifferentPrefixFieldContentTranslateTransformer()
	 * throws Exception {
	 * 
	 * OAIRecordMetadata record = new OAIRecordMetadata("dumyid",invalidRecord);
	 * 
	 ...
	 * 
	 * Boolean found = false; for (String occr :
	 * record.getFieldOcurrences("dc:test") ) { found |= occr.equals("Article");
	 * } assertFalse(found);
	 * 
	 * ////////////
	 * 
	 * trule.setTestValueAsPrefix(true); trule.transform( record );
	 * 
	 * 
	 * found = false; for (String occr : record.getFieldOcurrences("dc:test") )
	 * { found |= occr.equals("Article"); } assertTrue(found);
	 ...
	 * }
	 * 
	 * @Test public void testFieldNameTranslateTransformer() throws Exception {
	 * 
	 * OAIRecordMetadata record = new OAIRecordMetadata("dumyid",invalidRecord);
	 * 
	 * FieldNameTranslateRule trule = new FieldNameTranslateRule();
	 * trule.setSourceFieldName("dc:type"); trule.setTargetFieldName("dc:test");
	 * 
	 * Boolean found = false; for (String occr :
	 * record.getFieldOcurrences("dc:test") ) { found = true; }
	 * assertFalse(found);
	 * 
	 * 
	 * trule.transform( record );
	 ...
	 * 
	 * @Test public void testFieldContentNormalizeTransformer() throws Exception
	 * {
	 * 
	 * OAIRecordMetadata record = new OAIRecordMetadata("dumyid",invalidRecord);
	 * 
	 * int k = 0; for (String occr : record.getFieldOcurrences("dc:type") ) {
	 * 
	 * if ( occr.equals("info:eu-repo/semantics/article") ) k++;
	 * 
	 * } assertTrue(k==2);
	 * 
	 * 
	 ...
	 * trule.setRemoveInvalidOccurrences(true); trule.setValidationRule(ccrule);
	 * 
	 * trule.transform(record);
	 * 
	 * int occurrencesSize = 0; k = 0; for (String occr :
	 * record.getFieldOcurrences("dc:type") ) {
	 * 
	 * occurrencesSize++;
	 * 
	 * if ( occr.equals("info:eu-repo/semantics/article") ) k++;
	 ...
	 * }
	 * 
	 * assertTrue(k==1); assertTrue(occurrencesSize==1);
	 * 
	 * 
	 * System.out.println( record.toString() ); }
	 */
