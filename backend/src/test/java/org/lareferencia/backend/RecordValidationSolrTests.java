...
public class RecordValidationSolrTests {
	...
	public void testSave() throws Exception {
		 ...
		 * result.setId("0001");
		 * 
		 * Map<String, List<String>> dfieldmap = new HashMap<String,
		 * List<String>>(); List<String> l1 = new ArrayList<String>();
		 * List<String> l2 = new ArrayList<String>(); l1.add("HolaL1-1");
		 * l1.add("HolaL1-2"); l2.add("HolaL2-1"); l2.add("HolaL2-2");
		 * dfieldmap.put("f1", l1); dfieldmap.put("f2", l2);
		 * 
		 * 
	...
	public void testRecordWiredDriverValidator() throws Exception {
		/*
		 * Network network = new Network(); network.setAcronym("TEST");
		 * network.setInstitutionName("Inst"); network.setName("Repo");
		 * 
		 * NetworkSnapshot snapshot = new NetworkSnapshot();
		 * 
		 * snapshot.setNetwork(network);
		 * 
		 * OAIRecordMetadata record = new
		 * OAIRecordMetadata("dumyid",validRecord);
		 * 
		 * ValidatorResult vresult = validator.validate(record);
		 * 
		 * RecordValidationResult rvresult = new
		 * RecordValidationResult(snapshot, record, vresult);
		 * 
