...
public class LRDummyEarliestDateResolver implements EarliestDateResolver {
    private static final Logger log = LogManager.getLogger(LRDummyEarliestDateResolver.class);
