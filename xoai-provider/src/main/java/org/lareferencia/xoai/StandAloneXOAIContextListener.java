 ...
 */
public class StandAloneXOAIContextListener implements ServletContextListener
{
    private static Logger log = Logger.getLogger(StandAloneXOAIContextListener.class);
